...
public class MdVisitor implements IReportVisitor {
    public String extensionName = ".md";

    @Override
    public void visit(RaceResultsReport r) {
        System.out.println("Convertendo Resultados de corrida para " + this.extensionName);
        System.out.println("# Resultados " + r.getRaceName() + " / " + r.getUmaPosition() + "º lugar");
    ...
    public void visit(TrainingDeckReport r) {
        ...
        System.out.println("# Dados treinador " + r.getTrainerName());
    ...
    public void visit(UmaStatusReport r) {
        ...
        System.out.println("# Relatório " + r.getUmaName() + " / " + r.getFinalRank());
